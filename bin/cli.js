...
const { supportFile: defaultSupportFile } = require('@yassinouhadi/cypress-generic-package');
...
module.exports = defineConfig({
  ...
  e2e: {
    ...
    supportFile: ${overrides.supportFile ? `"${overrides.supportFile}"` : "defaultSupportFile"},
...
`;
  ...
  const { stepDefinitions: defaultStepDefinitions } = require('@yassinouhadi/cypress-generic-package');
  if (fs.existsSync(packageJsonPath)) {
    ...
    pkg["cypress-cucumber-preprocessor"] = {
      stepDefinitions: defaultStepDefinitions || "node_modules/@yassinouhadi/cypress-generic-package/dist/**/*.cy.js",
      html: {
        enabled: true,
      ...
      messages: {
        enabled: true,
        output: "cypress/reports/json/cucumber-report.ndjson"
      }
    };
