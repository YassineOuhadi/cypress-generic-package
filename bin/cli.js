...
module.exports = defineConfig({
  ...
  e2e: {
    ...
    supportFile: "${overrides.supportFile || "node_modules/@yassinouhadi/cypress-generic-package/cypress/support/e2e.ts"}",
...
`;
  ...
  if (fs.existsSync(packageJsonPath)) {
    ...
    pkg.scripts["cy:run"] = `CYPRESS_ENV_FILE='${envFile}' rm -rf cypress/reports && cypress run`;
    ...
    pkg["cypress-cucumber-preprocessor"] = {
      stepDefinitions: "node_modules/@yassinouhadi/cypress-generic-package/dist/**/*.cy.js",
      html: {
        enabled: true,
