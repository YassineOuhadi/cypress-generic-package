...
import {
    assertURLIncludes
} from "../../../shared/assertions/chainable";
...
class GenericPage extends GenericComponent implements IGenericPage {
    ...
    override init() {
        ...
        //TODO:
        // if (this.variables.URL) {
        //     this.setBaseUrl(this.variables.URL);
        // }

        // if (this.variables.FORM) {
        //     this.setFields(this.variables.FORM);
        // }
    ...
    isPageOpened(path?: string): Cypress.Chainable<boolean> {
        const urlToCheck = path ? this.getBaseUrl() + path : this.getBaseUrl();
        return assertURLIncludes(urlToCheck);
    }

    //TODO:
    // stubs for generic methods
    //   setBaseUrl(url: string) {
    //     // store internally or just use in navigate()
    //   }

    //   setFields(fields: any) { /* ... */ }
    //   setButtons(buttons: any) { /* ... */ }
    //   setMenu(menu: any) { /* ... */ }
    //   setElement(key: string, comp: any) { /* ... */ }
}
