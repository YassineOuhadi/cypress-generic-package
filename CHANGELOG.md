...
- Generic Steps Library engine to define Cucumber-style steps in a generic way.  
- Supports dynamic injection of selectors and parameterized actions.
- Service Support (HTTP & Real-Time)
